...
func TestFilescanner_JorjiScanFile(t *testing.T) {
  suite := []TestFilescanner_JorjiScanFile_TestCase{
    ...
    TestFilescanner_JorjiScanFile_TestCase{
      Testname: "Substractvaliditydays edge case 1",
      Filepath: "./testfile_subdays_edge1",
      ValidDays: 30,
    ...
    TestFilescanner_JorjiScanFile_TestCase{
      Testname: "Substractvaliditydays edge case 2",
      Filepath: "./testfile_subdays_edge2",
      ValidDays: 31,
      Substractvaliditydays: 1,
      Warnafterdays: 30,
      ExpectWarn: true,
    ...
    TestFilescanner_JorjiScanFile_TestCase{
      Testname: "Substractvaliditydays edge case 3",
      Filepath: "./testfile_subdays_edge3",
      ValidDays: 32,
      Substractvaliditydays: 1,
      Warnafterdays: 30,
      ExpectWarn: false,
